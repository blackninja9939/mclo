...
namespace mclo
{
	...
	/// @tparam Hasher The hasher algorithm to use, defaulting to @ref rapidhash.
	template <typename T, hasher Hasher = mclo::rapidhash>
	...
	template <hasher Hasher = mclo::rapidhash, std::ranges::forward_range Range, typename... Args>
